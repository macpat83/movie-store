...
public class Movie {
    ...
    public Movie(String name, String format, double rating) {
        ...
        this.format = format;
        this.rating = rating;
        this.sellingPrice = format.equals("BlueRay") ? 4.25 : 2.25;
        this.rentalPrice = format.equals("BlueRay") ? 1.99 : .99;
    ...
    public Movie(Movie source) {
        ...
        this.rentalPrice = source.rating;
    ...
    public void setFormat(String format) {
        ...
        this.format = format;
        setSellingPrice(format.equals("Blueray") ? 4.25 : 2.25);
        setRentalPrice(format.equals("Blueray") ? 1.99 : .99);
    }
